 ...
 // add each successive element in primesPolRho to obtain the 
 // next prime number (e.g. p = 2 + primesPolRho[0] = 3, 
 // p = p + primesPolRho[1] = 5, etc.)

static unsigned long int primesPolRho[549] = {
