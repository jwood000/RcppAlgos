...
template <typename T>
void CombResMain(T* mat, const std::vector<T> &v, const funcPtr<T> myFun,
...
template void CombResMain(int*, const std::vector<int>&,
...
template void CombResMain(double*, const std::vector<double>&,
