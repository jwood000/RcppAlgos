...
std::vector<int> nthCombMult(int n, int r, double dblIdx, mpz_t mpzIdx, 
                             std::vector<int> Reps) {
...
std::vector<int> nthCombGmp(int n, int r, double dblIdx, mpz_t mpzIdx, 
                            std::vector<int> Reps) {
...
std::vector<int> nthCombRepGmp(int n, int r, double dblIdx, mpz_t mpzIdx, 
                               std::vector<int> Reps) {
