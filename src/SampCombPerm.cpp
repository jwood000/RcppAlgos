...
//     
//     const double computedRows = GetComputedRows(IsMult, IsRep, n,
//                                                 m, Rm, freqs, myReps);
//     
...
//     
//     if (IsGmp) {
//         GetComputedRowMpz(computedRowMpz, IsMult,
...
//     
//     Rcpp::XPtr<nthResultPtr> xpNth = putNthResPtrInXPtr(IsMult, IsRep, IsGmp);
