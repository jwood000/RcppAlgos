reprex::reprex({
    ...
    #'
    #' The algorithm in `comboGroups` avoids all of this duplication by implementing a novel algorithm akin to [std::next_permutation](https://en.cppreference.com/cpp/algorithm/next_permutation) from the algorithm library in `C++`.
    #'
