comboGroups <- function(v, numGroups, retType = "matrix", lower = NULL,
    ...
    return(.Call(ComboGroupsCpp, v, numGroups, retType, lower,
                 upper, Parallel, nThreads, pkgEnv$nThreads, FALSE, NULL,
                 NULL, NULL, sample, FALSE, NULL, PACKAGE = "RcppAlgos"))
}
...
comboGroupsSample <- function(v, numGroups, retType = "matrix", n = NULL,
    ...
    return(.Call(ComboGroupsCpp, v, numGroups, retType, NULL, NULL,
...
comboGroupsCount <- function(v, numGroups) {
    return(.Call(ComboGroupsCountCpp, v, numGroups, PACKAGE = "RcppAlgos"))
}