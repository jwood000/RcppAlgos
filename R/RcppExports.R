...
CombinatoricsRcpp <- function(Rv, Rm, Rrepetition, f1, f2, lim, numRow, RIsComb, RIsFactor) {
    .Call(`_RcppAlgos_CombinatoricsRcpp`, Rv, Rm, Rrepetition, f1, f2, lim, numRow, RIsComb, RIsFactor)
}
