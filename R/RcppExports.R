...
CombinatoricsRcpp <- function(Rv, Rm, Rrepetition, fun1, fun2, lim, numRow, RIsComb) {
    .Call(`_RcppAlgos_CombinatoricsRcpp`, Rv, Rm, Rrepetition, fun1, fun2, lim, numRow, RIsComb)
}
