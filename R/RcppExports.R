...
CombinatoricsRcpp <- function(Rv, Rm, Rrepetition, RFreqs, Rlow, Rhigh, f1, f2, lim, IsComb, RKeepRes, IsFactor, IsCount) {
    .Call(`_RcppAlgos_CombinatoricsRcpp`, Rv, Rm, Rrepetition, RFreqs, Rlow, Rhigh, f1, f2, lim, IsComb, RKeepRes, IsFactor, IsCount)
}
...
SampleRcpp <- function(Rv, Rm, Rrepetition, RFreqs, Rsample, IsComb, IsFactor, computedRows) {
    .Call(`_RcppAlgos_SampleRcpp`, Rv, Rm, Rrepetition, RFreqs, Rsample, IsComb, IsFactor, computedRows)
}
