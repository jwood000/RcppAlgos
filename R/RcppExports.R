...
CombinatoricsRcpp <- function(Rv, Rm, Rrepetition, RFreqs, Rlow, Rhigh, f1, f2, lim, IsComb, RKeepRes, IsFactor, IsCount, stdFun, myEnv) {
    .Call(`_RcppAlgos_CombinatoricsRcpp`, Rv, Rm, Rrepetition, RFreqs, Rlow, Rhigh, f1, f2, lim, IsComb, RKeepRes, IsFactor, IsCount, stdFun, myEnv)
}
