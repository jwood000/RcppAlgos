compositionsGeneral <- function(v, m = NULL, repetition = FALSE,
    ...
    return(.Call(`_RcppAlgos_CombinatoricsCnstrt`, v, m, repetition, freqs,
                 lower, upper, "sum", "==", GetTarget(v, target), FALSE,
                 FALSE, FALSE, nThreads, pkgEnv$nThreads, tolerance, TRUE))
}
...
compositionsRank <- function(..., v, repetition = FALSE,
    ...
    GetRankPart(..., v = v, repetition = repetition, freqs = freqs,
                target = target, IsComposition = TRUE)
}
...
compositionsSample <- function(v, m = NULL, repetition = FALSE, freqs = NULL,
    ...
    return(.Call(`_RcppAlgos_SamplePartitions`, v, m, repetition, freqs,
                 ...
                 GetTarget(v, target), NULL, new.env(), TRUE))
}
...
compositionsIter <- function(v, m = NULL, repetition = FALSE,
    ...
    InitVals <- .Call(`_RcppAlgos_GetClassVals`, v, m, repetition, freqs,
                      TRUE, NULL, nThreads, pkgEnv$nThreads, TRUE, TRUE)
