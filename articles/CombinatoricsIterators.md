...
In version `2.4.3` without caching, the profiler records `9790135` total
...
`3246121`. This substantial reduction indicates that a large portion of
...
Just over `3` seconds isn’t bad, however 4 GBs could put a strain on
your computer.
...
faster as well (`3.526 / 1.161 ~= 3.037`)! Our gains came strictly from
