...
Just like it's base R counterpart `expand.grid`, we can generate the Cartesian product using `expandGrid`. There are a few caveats that are discussed in detail in the docs (see `?expandGrid`). The main difference is that `expandGrid` varies the first column the slowest and if all of the inputs are of the same type, a `matrix` will be returned.
...
#>          baseR 13.133 12.935 12.864 12.800 11.83 19.41   100
#>  RcppAlgos_Ser  3.461  3.437  3.589  3.408  3.25 10.37   100
#>  RcppAlgos_Par  1.000  1.000  1.000  1.000  1.00  1.00   100
```
