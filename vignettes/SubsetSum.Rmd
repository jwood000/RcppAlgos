...
```r
system.time(genParts <- partitionsGeneral(seq(121, 221, 5), 13,
                                          TRUE, target = 2613))
#>  user  system elapsed
#> 0.006   0.002   0.008    ## over 100 thousand results out of a possible 573 million
...
system.time(genMultiParts <- partitionsGeneral(seq(121, 221, 5), 13,
                                               ...
                                               targe = 2613))
#>  user  system elapsed
#> 0.007   0.003   0.011    ## over 70 thousand results out of a possible 256 million!
...
```r
system.time(genDistParts <- partitionsGeneral(seq(-173L, 204L, 13L),
                                              11, target = -460))
#>  user  system elapsed
#> 0.003   0.000   0.003
...
system.time(genParts2 <- partitionsGeneral(inpVec, 13, TRUE, target = 2613))
#>  user  system elapsed
#> 0.096   0.005   0.101  ##  We still find over 100 thousand results out of
...
Although the above was about 13 times slower than the first example dealing with 573 million combinations (101 milliseconds vs. 8 milliseconds), we are still dealing in milliseconds!!! For reference, version `2.3.4` takes about 18 seconds to find all 118,560 solutions.
...
sort(mySamp)
#>  [1] -98 -97 -96 -95 -81 -77 -74 -65 -60 -59 -58 -54 -52 -43 -36 -33 -30
#> [18] -27 -12  -9  -2  -1   3   8   9  10  13  21  27  30  33  35  42  45
#> [35]  49  52  53  57  61  63  64  70  73  76  83  84  88  91  96 100
...
#>  optimized  1.00000  1.00000  1.0000  1.00000  1.00000  1.00000    20  a
#>      brute 46.86513 46.87535 49.3752 47.36287 47.81427 60.11692    20   b
...
#>  [1] 1.500000 1.499999 1.500001 1.500000 1.500000 1.500001 1.500000 1.500000 1.500000 1.500000
#> [11] 1.499999 1.500000 1.500001 1.500001 1.499999 1.499999 1.500001 1.500000 1.500001 1.500000
```
